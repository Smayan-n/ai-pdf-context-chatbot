			...
			>
				<div className="h-full px-3 py-4 overflow-y-auto sidebar z-10">
					<a
						...
						className="flex items-center p-2 text-white rounded-lg group hover:cursor-pointer bg-gray-950"
					>
						<svg
						...
						<span className="ms-3 group-hover:text-white">New Conversation</span>
					</a>
					<br />
					<br />
					<div>
